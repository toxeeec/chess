	...
	return (
		<RacSlider {...props}>
			...
			<SliderTrack className="h-5">
				...
				<SliderThumb
					name={name}
					className="top-1/2 size-6 rounded-full border-2 border-neutral-800 bg-neutral-200 focus-visible:outline focus-visible:outline-neutral-200 dragging:opacity-90 disabled:bg-neutral-700"
				/>
			</SliderTrack>
		</RacSlider>
	)
