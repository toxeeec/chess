/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bef3d8a0ba19c18105944ffe968bb569)
// Runtime types generated with workerd@1.20260603.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_D1_API_TOKEN: string;
	GAME_SERVER: DurableObjectNamespace<import("./src/server").GameServer>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_API_TOKEN">> {}
}
